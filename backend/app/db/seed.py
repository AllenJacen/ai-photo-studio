...
AI_MODELS = [
    ...
    },
    {
        ...
        "description": "字节跳动出品，中文场景理解强，可文生图也可传参考图做图生图",
        "provider": "bytedance",
        "model_type": "image2image",
        "capabilities": ["chinese_aesthetics", "portrait", "high_res", "img2img"],
        "credit_multiplier": 1.0,
    ...
    {
        "id": "seededit_3",
        "display_name": "豆包 SeedEdit 3.0",
        "description": "字节跳动图像编辑专用,主体保留+局部编辑,适合换装、换背景、保留人脸",
        "provider": "bytedance",
        "model_type": "image2image",
        "capabilities": ["face_preservation", "img2img", "edit", "chinese_aesthetics"],
        "credit_multiplier": 1.0,
        "avg_generation_time_s": 18,
        "max_resolution": "2048x2048",
        "is_active": True,
        "status": "available",
    },
